...
<body>
    ...
    <header class="top-nav">
        ...
        <div class="nav-right">
            ...
            <div class="profile-wrapper" id="profileWrapper">
                ...
                <div class="profile-dropdown" id="profileDropdown"><a href="librarian_profile.php"><i class="fas fa-user"></i> Profile</a><a href="#"><i class="fas fa-cog"></i> Settings</a><hr><a href="/ArchivingThesis/authentication/logout.php"><i class="fas fa-sign-out-alt"></i> Logout</a></div>
            </div>
        </div>
    </header>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="librarian_profile.php" class="nav-item active"><i class="fas fa-user-circle"></i><span>My Profile</span></a>
        </div>
        ...
        <div class="profile-container">
            ...
            <div class="profile-grid">
                <div class="profile-card">
                    ...
                    <div class="info-row"><span class="info-label">Full Name:</span><span class="info-value"><?= htmlspecialchars($fullName) ?></span></div>
                    <div class="info-row"><span class="info-label">Email Address:</span><span class="info-value"><?= htmlspecialchars($user_email) ?></span></div>
                    <div class="info-row"><span class="info-label">Username:</span><span class="info-value"><?= htmlspecialchars($username) ?></span></div>
                    <div class="info-row"><span class="info-label">Phone Number:</span><span class="info-value"><?= htmlspecialchars($user_phone) ?></span></div>
                    <div class="info-row"><span class="info-label">Address:</span><span class="info-value"><?= htmlspecialchars($user_address) ?></span></div>
                    <div class="info-row"><span class="info-label">Role:</span><span class="info-value"><?= htmlspecialchars($user_role) ?></span></div>
                </div>
            ...
            <div class="profile-grid">
                <div class="profile-card">
                    ...
                    <div class="stats-mini-grid">
                        <div class="stat-mini-card"><div class="stat-mini-number"><?= number_format($stats['total_theses']) ?></div><div class="stat-mini-label">Total Theses</div></div>
                        <div class="stat-mini-card"><div class="stat-mini-number"><?= number_format($stats['total_students']) ?></div><div class="stat-mini-label">Students</div></div>
                        <div class="stat-mini-card"><div class="stat-mini-number"><?= number_format($stats['total_faculty']) ?></div><div class="stat-mini-label">Faculty</div></div>
                        <div class="stat-mini-card"><div class="stat-mini-number"><?= number_format($stats['pending_reviews']) ?></div><div class="stat-mini-label">Pending Reviews</div></div>
                        <div class="stat-mini-card"><div class="stat-mini-number"><?= number_format($stats['completed_theses']) ?></div><div class="stat-mini-label">Completed</div></div>
                        <div class="stat-mini-card"><div class="stat-mini-number"><?= number_format($stats['total_theses'] - $stats['completed_theses']) ?></div><div class="stat-mini-label">In Progress</div></div>
                    </div>
                </div>
                ...
                <div class="profile-card">
                    ...
                    <div class="activity-list">
                        ...
                        <div class="activity-item"><div class="activity-icon"><i class="fas <?= $activity['icon'] ?>"></i></div><div class="activity-details"><div class="activity-action"><?= htmlspecialchars($activity['action']) ?></div><div class="activity-title"><?= htmlspecialchars($activity['title']) ?></div><div class="activity-time"><?= $activity['date'] ?></div></div></div>
                        <?php endforeach; ?>
                    </div>
                </div>
            </div>
